...
public class DetectService {
	...
	public OcrOutputDto detectText(OcrInputDto ocrInputDto) throws Exception {

		List<String> imageTypes = getSupportedImageExtensions();
		...
		if ("PDF".equalsIgnoreCase(fileExtension)) {
			...
			detectDocumentTextGcs(ocrInputDto.getGcsSourcePath());
			extractedText = detectDocumentTextGcs(ocrInputDto.getGcsSourcePath());
		}

		extractedText = removeNumbersAndSpecialChars(extractedText);

		ocrOutputDto.setDocName(getFileName(ocrInputDto.getGcsSourcePath()));
		ocrOutputDto.setExtractedText(extractedText);
		return ocrOutputDto;
	}
	...
	public String detectDocumentTextGcs(String gcsPath) throws IOException {
		List<AnnotateImageRequest> requests = new ArrayList<>();
	...
	public String detectDocumentsGcs(String gcsSourcePath, String gcsDestinationPath) throws Exception {
		...
		try (ImageAnnotatorClient client = ImageAnnotatorClient.create()) {
			...
			// The batch size sets how many pages should be grouped into each json
			// System.output file.
	...
	private String removeNumbersAndSpecialChars(String text) {
